...
public:
    ...
    { 
        ...
        m_isr_handler = (HAL::INTC::isr_handler_t)sys_timer_irqhandler;
    }
    ...
    **/
    ...
    {          
        ...
        HAL::INTC::register_handler(m_DMTIMER_sys_isr_num, m_isr_handler);     // Registering dmtimer_irqhandler
        HAL::INTC::priority_set(m_DMTIMER_sys_isr_num, priority);      // Set the lowest priority
        HAL::INTC::unmask_interrupt(m_DMTIMER_sys_isr_num);
    ...
    void sys_interrupt_enable()  { HAL::INTC::unmask_interrupt(m_DMTIMER_sys_isr_num);  }
    void sys_interrupt_disable() { HAL::INTC::mask_interrupt(m_DMTIMER_sys_isr_num); }

private:  
         HAL::INTC::isr_handler_t  m_isr_handler;
