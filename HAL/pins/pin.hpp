...
namespace HAL::PINS
{
    ...
    public:   
                ...
                void  gpio_module_init() noexcept
                {
                ...
                void  gpio_module_enable() noexcept { m_gpio_regs.CTRL.b.DISABLEMODULE = 0x0; }
                void  gpio_module_disable() noexcept { m_gpio_regs.CTRL.b.DISABLEMODULE = 0x1; }

                void  gpio_module_reset() noexcept
                {
                 ...
                 */
                void configure_as_gpio_output(T gpio_mode)
                {
                    gpio_module_init();
                 ...
                 */
                void configure_as_gpio_input(T gpio_mode)
                {
                    gpio_module_init();
                    sel_pinmode(gpio_mode);
                ...
                **/
                void  sel_pinmode(T pinmode) noexcept
                {
                ...
                **/
                void  pullup_enable(bool pull_en) noexcept
                {
                    if(pull_en)
                ...
                **/
                void  sel_pull_type(REGS::CONTROL_MODULE::e_PUTYPESEL putypesel) noexcept { m_cntrmdl_reg.b.putypesel = putypesel; }
                ...
                **/
                void  sel_rxactive(REGS::CONTROL_MODULE::e_RXACTIVE rxactive) noexcept { m_cntrmdl_reg.b.rxactive = rxactive; }
                ...
                **/
                void  sel_slewrate(REGS::CONTROL_MODULE::e_SLEWCTRL slewctrl) noexcept { m_cntrmdl_reg.b.slewctrl = slewctrl; }
                ...
                */
                void  dir_set(REGS::GPIO::e_PINDIR pindir) noexcept
                {
                ...
                *
                */
                REGS::GPIO::e_PINDIR  dir_get() noexcept
                {
                ...
                **/
                void  set() noexcept { m_gpio_regs.SETDATAOUT.reg = m_pinbitmsk; }

                /**
                * @brief  This API drives an output GPIO pin to a logic LOW state.
                **/
                void  clear() noexcept { m_gpio_regs.CLEARDATAOUT.reg = m_pinbitmsk; }
                ...
                */
         inline bool  read_input() const noexcept { return (bool)(m_gpio_regs.DATAIN.reg & m_pinbitmsk); }
                ...
                *  - true  - indicating a logic HIGH(logic 1) on the pin.
                */
         inline bool  read_output() const noexcept { return (bool)(m_gpio_regs.DATAOUT.reg & m_pinbitmsk); }
                 ...
                 *         see debounce_time_config(uint32_t debounce_time).
                 */
                void  debounce_disable() noexcept
                {
                    m_gpio_regs.DEBOUNCENABLE.reg &= ~m_pinbitmsk;  // clear bit in register
                    m_gpio_regs.DEBOUNCENABLE.reg &= ~m_pinbitmsk;  // program bit in register
                }
                 ...
                 */
                void  int_enable(uint32_t intline) noexcept
                {
                 ...
                 *    transmit interrupt requests due to transitions on specified pin\n
                 */
                void  int_disable(uint32_t intline) noexcept
                {
                    if(REGS::GPIO::INT_LINE_1 == intline)
                 ...
                 */
                void  int_type_set(REGS::GPIO::e_INT_TYPE evnt_type) noexcept
                {
                    switch(evnt_type)
                    {
                 ...
                 */
                uint32_t  int_type_get() noexcept
                {
                 ...
                 */
                bool  int_status(uint32_t intline) noexcept
                {
                    bool int_sts = false;
                 ...
                 */
                bool  raw_int_status(uint32_t intline) noexcept
                {
                    bool int_sts = false;
                 ...
                 *   corresponding to interrupt line 2\n *
                */
                void  int_clear(uint32_t intline) noexcept
                {
                    if(REGS::GPIO::INT_LINE_1 == intline)
                 ...
                 *        GPIO pin.
                 */
                void  trigger_int(uint32_t intline) noexcept
                {
                    if(REGS::GPIO::INT_LINE_1 == intline)
                 ...
                 *           request.\n
                 */
                void  int_wakeup_enable(uint32_t intline) noexcept
                {
                    if(REGS::GPIO::INT_LINE_1 == intline)
                 ...
                 *   Wakeup Interrupt Line 2\n
                 */
                void  int_wakeup_disable(uint32_t intline) noexcept
                {
                    if(REGS::GPIO::INT_LINE_1 == intline)
                        m_gpio_regs.IRQWAKEN_0.reg &= ~m_pinbitmsk;
                    else
